...
1. **Правила** — вставьте содержимое `docs/rules-section.ru.md` в конец вашего `~/.claude/CLAUDE.md` (или канонического AGENTS.md, если у вас мульти-агентная схема). Скиллы ссылаются на эти правила как на «§13» — если у вас другая нумерация разделов, оставьте заголовок как есть или поправьте ссылки.
2. **Скиллы**:
   ```bash
