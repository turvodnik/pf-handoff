...
Инструмент-компаньон: **pf-workflow** (конвейер задач pf-*: спека → тикеты → исполнители → ревью). pf-handoff самодостаточен; вместе они образуют полную систему рабочих процессов.
